...
class TestEscalations(unittest.TestCase):
    ...
    def test_slack_escalation_link(self):
        ...
        url = (
            "https://console.cloud.google.com/logs/viewer?project=TEST_PROJECT&advancedFilter=resource.labels.container_name%3Dmock_config_name",
        )
    ...
    def test_slack_escalation_long_link(self):
        ...
        url = (
            "https://console.cloud.google.com/logs/viewer?project=TEST_PROJECT&advancedFilter=resource.labels.container_name%3Dmock_config_name+resource.labels.cluster_name%3DTEST_CLUSTER+resource.labels.location%3DTEST_REGION",
        )
        self.assertIn(url, more_details)
